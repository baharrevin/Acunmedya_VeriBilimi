...
def ogrenci_sorgula():
    if len(ogrenci_listesi) == 0:
        ...
        for ogrenciler in ogrenci_listesi:
            print(f"Numara: {ogrenciler['öğrencinin numarası']}\nAd: {ogrenciler['öğrencinin adı']}\nSoyad: {ogrenciler['öğrencinin soyadı']}\nBölüm: {ogrenciler['öğrencinin bölümü']}\nNot Ortalaması: {ogrenciler['öğrencinin not ortalaması']} ***")
        ...
        for ogrenciler in ogrenci_listesi:
            if ogrenciler["öğrencinin numarası"] == ogr_num: 
                print(f"* {ogr_num} numaralı öğrencinin bilgileri * ")
                ...
                return
        print(f"{ogr_num} numaralı kayıtlı öğrenci bulunamadı... Menüye aktarılıyorsunuz...")
        ogrenci_sistemi()
